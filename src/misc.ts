class LoreManager {
    public readonly theme: string = "Alone is how the whisper ends...";
    /**
...
class Renderer {
    ...
    public fillRect(color: string, x: number, y:number, width: number, height: number):void {
...
class MenuController {
    ...
    constructor(title: string, choices: Array<string>) {
        this.title = title;
        this.choices = choices;
    }
}

const enum TransitionTypes {
    UpwardSwipe
}
